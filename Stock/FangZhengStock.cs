...
{
    //方正证券的抽取方法
    public class FangZhengStock:StockData
    {
         List<string> subjects;
         List<string> blackString;
         public FangZhengStock() { }
         public FangZhengStock(StockData stockData)
        {
            ...
            subjects.Add("投资要点");
          //  subjects.Add("公司投资评级的说明");
          //  subjects.Add("目录");
           // subjects.Add("行业投资评级的说明");
          //  subjects.Add("特别声明与免责条款");
            subjects.Add("事件");
            subjects.Add("点评");
          //  subjects.Add("分析师声明");
         //   subjects.Add("免责声明");
        ...
        //    subjects.Add("免责声明");
         ...
         public string extractContent(string[] lines)
         {
             ...
             for (int i = 0; i < lines.Length; i++)
             {
                 ...
                 if (temp.Contains("公司事件点评报告"))
                     continue;
                 if (temp.Contains("价值分析报告"))
                     continue;
                 if (temp.Contains("公司调研快报"))
                     continue;
                 if (temp.Contains("公司财报点评"))
                     continue;
                 if (temp.Contains("公司深度报告"))
                     continue;
                 if (temp.Contains("公司调研简报"))
                     continue;
                 if (temp.Contains("研究源于数据") && temp.Contains("研究创造价值"))
                     continue;
                 if (temp.Contains("请务必阅读最后特别声明与免责条款"))
                     continue;
