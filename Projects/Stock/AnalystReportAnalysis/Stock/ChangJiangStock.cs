...
namespace Stock
{
    public class ChangJiangStock:StockData
    {
         List<string> subjects;
         public ChangJiangStock() { }
         public ChangJiangStock(StockData stockData) //高于人名的号码不可以要，抽出来的高于人名的号码可能是假的
        {
         ...
         public string extractContent(string[] lines)
         {
             ...
             for (int i = 0; i < lines.Length; i++)
             {
                 ...
                 if (temp.Contains("请阅读最后评级说明和重要声明"))
                     continue;
                 if (temp.Contains("公司报告") && temp.Contains("点评报告"))
                     continue;
