...
{
    //平安证券的抽取方法
    public class PingAnStock:StockData
    {
        List<string> subjects;
         public PingAnStock() { }
         public PingAnStock(StockData stockData) //高于人名的号码不可以要，抽出来的高于人名的号码可能是假的
        {
            ...
            subjects.Add("事件");
            subjects.Add("平安观点");
            subjects.Add("平安证券综合研究所投资评级");
            subjects.Add("公司声明及风险提示");
            subjects.Add("股票投资评级");
            subjects.Add("行业投资评级");
            subjects.Add("免责条款");
        }
         ...
         public string extractContent(string[] lines)
         {
             ...
             for (int i = 0; i < lines.Length; i++)
             {
                 ...
                 if (temp.Contains("请阅读最后一页信息披露和重要声明"))
                     continue;
                 if (temp.Contains("公司公告点评"))
                     continue;
                 if (temp.Contains("公司点评报告"))
                     continue;
                 if (temp.Contains("公司深度研究报告"))
                     continue;
                 if (temp.Contains("公司调研报告"))
                     continue;
                 if (temp.Equals("其他"))
                     continue;
                 if (temp.Contains("敬请参阅最后一页特别声明"))
                     continue;
                 if (temp.Contains("敬请参阅特别声明"))
                     continue;
